	...
	setup: function(frm) {
		frm.make_methods = {
			'Print Purchase Order': () => {
				frappe.call({
					method: 'aetesis.overrides.purchase_order._make_print_purchase_order', 
					args: {
						company: frm.company,
						purchase_order: frm.name,
						items: frm.items,
						transaction_date: frm.transaction_date,
						supplier: frm.supplier,
						schedule_date: frm.schedule_date,
						total_qty: frm.total_qty,
					}, 
					freeze: true,
				})
